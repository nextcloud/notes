OC.L10N.register(
    ...
    "Deleted {number} notes" : "{number} adet not silindi",
    ...
    "Error during preparing note for deletion." : "Not silinmeye hazırlanırken hata.",
    "Empty note" : "Not boş",
    "Write …" : "Yazın …",
    "Details" : "Ayrıntılar",
    "Preview" : "Ön izleme",
    ...
    "See JavaScript console and server log for details." : "Detaylar için JavaScript konsolunu ve sunucu kütüklerine bakınız.",
    ...
    "Undo delete has failed for note {title}." : "{title} notu için silinme geri alma başarısız.",
