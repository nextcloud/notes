OC.L10N.register(
    ...
    "Zen mode ({shortcut})" : "Zen kipi ({shortcut})",
    "Exit zen mode ({shortcut})" : "Zen kipinden çık ({shortcut})",
    "Share" : "Paylaş",
    ...
    "Please see Nextcloud server log for details." : "Ayrıntılar için Nextcloud sunucu günlüğü kayıtlarına bakın.",
    "Custom" : "Özel",
    ...
    "Remove any styles from the selected text" : "Seçilmiş yazıdaki tüm biçemleri kaldır",
    ...
    "For new notes" : "Yeni notlar için",
    "Custom file extension" : "Özel dosya uzantısı",
    "Files" : "Dosyalar",
    ...
    "Android" : "Android",
    "iPhone and iPad" : "iPhone ve iPad",
    "Rich text editor" : "Zengin yazı düzenleyici",
    "You can now switch to use the easy to use and distraction free rich text editor. It allows you to edit notes without seeing any Markdown marks." : "Artık kullanımı kolay ve dikkat dağıtmayan zengin yazı düzenleyiciyi kullanabilirsiniz. Notları herhangi bir Markdown kod imi görmeden düzenlemenizi sağlar.",
    ...
    "Use rich editor" : "Zengin yazı düzenleyici kullanılsın",
    ...
    "Sharing is not available right now." : "Paylaşım şu anda kullanılamıyor.",
    "Failed to load the sharing sidebar." : "Paylaşım kenar çubuğu yüklenemedi.",
    "Unable to load the selected note for sharing." : "Seçilmiş not paylaşılmak üzere yüklenemedi.",
    "Today" : "Bugün",
    "Yesterday" : "Dün",
    "This week" : "Bu hafta",
    ...
    "This month" : "Bu ay",
    "Last month" : "Geçen ay",
    "Could not read the template. Creating an empty note instead." : "Kalıp okunamadı. Bunun yerine boş bir not ekleniyor.",
    "Search for notes" : "Notlarda ara",
    "Loading …" : "Yükleniyor…",
    ...
    "Use Markdown markups to style your text." : "Yazıyı biçimlendirmek için Markdown kod imlerini kullanın.",
    "Organize your notes in categories." : "Kategorileri kullanarak notlarınızı gruplayabilirsiniz.",
    "Start writing a note by clicking on “{newnote}”." : "“{newnote}” üzerine tıklayarak not yazmaya başlayın.",
    "Note not found." : "Not bulunamadı.",
    "Note is locked." : "Not kilitlenmiş.",
    "Insufficient storage." : "Depolama alanı yetersiz.",
    "See JavaScript console and server log for details." : "Ayrıntılı bilgi almak için JavaScript konsoluna ve sunucu günlüğü kayıtlarına bakın.",
    ...
    "Renaming category \"{category}\" has failed." : "\"{category}\" kategorisi yeniden adlandırılamadı.",
    "Deleting category \"{category}\" has failed." : "\"{category}\" kategorisi silinemedi.",
