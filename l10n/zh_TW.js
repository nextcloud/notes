OC.L10N.register(
    ...
    "User defined" : "使用者定義",
    "Open in rich text mode" : "以格式化文字模式開啟",
    ...
    "Install the app for your mobile phone in order to access your notes from everywhere." : "在您的行動裝置上安裝應用程式以便隨時隨地存取您的筆記。",
