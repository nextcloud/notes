OC.L10N.register(
    ...
    "Notes settings" : "Paràmetres de Notes",
    ...
    "Remove any styles from the selected text" : "Suprimeix qualsevol estil del text seleccionat",
    ...
    "Toggle heading for current line" : "Commuta l'encapçalament per a la línia actual",
    "SHIFT" : "MAJÚS",
    ...
    "Android app: {notes}" : "Aplicació per a Android: {notes}",
    "iOS app: {notes}" : "Aplicació per a iOS: {notes}",
    ...
    "This option can also be changed later on in the Notes app settings." : "Aquesta opció també es pot canviar més endavant als paràmetres de l'aplicació Notes.",
    ...
    "Error while renaming note." : "S'ha produït un error en canviar el nom de la nota.",
    "Error during preparing note for deletion." : "S'ha produït un error en preparar la nota per la supressió.",
    "Share" : "Comparteix",
    "Change category" : "Canvia categoria",
    "Rename" : "Canvia el nom",
    "Rename note" : "Canvia el nom de la nota",
    ...
    "Search for notes" : "Cerca notes",
    "Loading …" : "S'està carregant…",
    "Find in all categories" : "Troba en totes les categories",
