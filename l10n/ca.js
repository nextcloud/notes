OC.L10N.register(
    ...
    "Please chose a valid path in {label} (bottom left corner)." : "Trieu un camí vàlid a {label} (cantonada inferior esquerra).",
    ...
    "No search result for “{search}” in {category}" : "No hi ha resultats de cerca de «{search}» a {category}",
    "No search result for “{search}”" : "No hi ha resultats de cerca de «{search}»",
    ...
    "Save failed. Click to retry." : "S'ha produït un error en desar. Feu clic per tornar-ho a provar.",
    "Set category" : "Defineix la categoria",
    "Category" : "Categoria",
    "Uncategorized" : "Sense categoria",
    "Click here to save manually" : "Feu clic aquí per desar la nota manualment",
    ...
    "Use Markdown markups to style your text." : "Utilitzeu el format Markdown per donar estil al text.",
    "Organize your notes in categories." : "Organitzeu les vostres notes en categories.",
    "Install the app for your mobile phone in order to access your notes from everywhere." : "Instal·leu l'aplicació al mòbil per poder accedir a les vostres notes des de qualsevol lloc.",
    "Android app" : "Aplicació per a l'Android",
    "iOS app" : "Aplicació per a l'iOS",
    "Start writing a note by clicking on “{newnote}” in the app navigation." : "Per començar a escriure una nota, feu clic a «{newnote}» a la navegació de l'aplicació.",
