OC.L10N.register(
    ...
    "Search result for \"{{search}}\"" : "Søkeresultater for \"{{search}}\"",
    "No search result for {{search}} in {{SelectedCategory}}" : "Ingen søkeresultater for {{search}} under {{SelectedCategory}}",
    "No search result for {{search}}" : "Ingen søkeresultater for {{search}}",
