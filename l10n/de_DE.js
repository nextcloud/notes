OC.L10N.register(
    ...
    "The Notes app is a distraction free notes taking app for [Nextcloud](https://www.nextcloud.com/). It provides categories for better organization and supports formatting using [Markdown](https://en.wikipedia.org/wiki/Markdown) syntax. Notes are saved as files in your Nextcloud, so you can view and edit them with every Nextcloud client. Furthermore, a separate [REST API](https://github.com/nextcloud/notes/blob/master/docs/api/README.md) allows for an easy integration into third-party apps (currently, there are notes apps for [Android](https://github.com/nextcloud/notes-android), [iOS](https://github.com/nextcloud/notes-ios) and the [console](https://git.danielmoch.com/nncli/about) which allow convenient access to your Nextcloud notes). Further features include marking notes as favorites." : "Die Notizen-App ist eine ablenkungsfreie Notizen-App für [Nextcloud](https://www.nextcloud.com/). Siebietet Kategorien für eine bessere Organisation und unterstützt die Formatierung in [Markdown](https://en.wikipedia.org/wiki/Markdown)-Syntax. Notizen werden als Dateien in Ihrer Nextcloud gespeichert, sodass sie mit jedem Nextcloud-Client angezeigt und bearbeitet werden können. Darüber hinaus ermöglicht eine separate [REST-API] (https://github.com/nextcloud/notes/blob/master/docs/api/README.md) eine einfache Integration in Apps von Drittanbietern (derzeit gibt es Notizen-Apps für [Android](https://github.com/nextcloud/notes-android), [iOS](https://github.com/nextcloud/notes-ios) und die [Konsole](https://git. danielmoch.com/nncli/about), die einen bequemen Zugriff auf Ihre Nextcloud-Notizen ermöglichen). Eine weitere Funktion ist das Markieren von Notizen als Favorit.",
    "Help" : "Hilfe",
    ...
    "You can now switch to use the easy to use and distraction free rich text editor. It allows you to edit notes without seeing any markdown marks." : "Sie können jetzt zum benutzerfreundlichen und ablenkungsfreien Rich-Text-Editor wechseln. Sie können Notizen bearbeiten, ohne Markdown-Codes zu sehen.",
