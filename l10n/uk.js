OC.L10N.register(
    ...
    "You can create subcategories by using “/” as delimiter between parent category and subcategory, e.g. “{parent}/{sub}”." : "Ви можете створювати підкатегорії із застосуванням \"/\" як роздільника між батьківською категорією та підкатегорією, наприклад. \"{parent}/{sub}\".",
