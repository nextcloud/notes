OC.L10N.register(
    ...
    "Deleted {title}" : "Видалено {title}",
    "Undo Delete" : "Скасувати видалення",
    ...
    "Notes settings" : "Налаштування нотаток",
    "Folder to store your notes" : "Папка для зберігання нотаток",
    ...
    "You cannot select images outside of your notes folder. Your notes folder is: {folder}" : "Ви не можете вибрати зображення за межами папки нотаток. Ваша папка нотаток: {folder}",
    ...
    "Error during preparing note for deletion." : "Помилка під час підготовки нотатки до видалення.",
    ...
    "Undo delete has failed for note {title}." : "Не вдалося скасувати видалення нотатки {title}.",
    "Deleting note {id} has failed." : "Не вдалося видалити нотатку {id}.",
