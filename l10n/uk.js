OC.L10N.register(
    ...
    "For new notes" : "Для нових нотаток",
    "Custom file extension" : "Власне розширення файлів",
    "Files" : "Робота з файлами",
    "Notes folder" : "Каталог для Нотаток",
    "Show hidden files" : "Показувати приховані файли",
    "Load recently updated note on startup" : "Завантажувати останні оновлені нотатки при запуску",
    "Mobile apps" : "Застосунки",
    "Shortcuts" : "Скорочення",
    "_Delete category \"{category}\" and its {count} note?_::_Delete category \"{category}\" and its {count} notes?_" : ["Вилучити категорію \"{category}\" та {count} нотатку в ній?","Вилучити категорію \"{category}\" та {count} нотатки в ній?","Вилучити категорію \"{category}\" та {count} нотаток в ній?","Вилучити категорію \"{category}\" та {count} нотаток в ній?"],
    "Delete category" : "Вилучити категорію",
    "Delete" : "Вилучити",
    "Cancel" : "Скасувати",
    ...
    "Android" : "Android",
    "iPhone and iPad" : "iPhone та iPad",
    ...
    "Sharing is not available right now." : "Спільний доступ не доступнй зараз.",
    "Failed to load the sharing sidebar." : "Не вдалося завантажити панель спільного доступу.",
    "Unable to load the selected note for sharing." : "Не вдалося завантажити вибрану нотатку для спільного доступу.",
    "Today" : "Сьогодні",
    "Yesterday" : "Вчора",
    ...
    "Could not read the template. Creating an empty note instead." : "Не вдалося застосувати шаблон. Буде створено порожню нотатку.",
    "Search for notes" : "Пошук нотаток",
    "Loading …" : "Завантаження…",
    "Find in all categories" : "Шукати в усіх категоріях",
    "Blank note" : "Порожня нотатка",
    ...
    "Start writing a note by clicking on “{newnote}”." : "Почніть писати нотатку, для цього клацніть \"{newnote}\".",
    ...
    "Renaming category \"{category}\" has failed." : "Перейменування категорії \"{category}\" не вдалося.",
    "Deleting category \"{category}\" has failed." : "Вилучення категорії \"{category}\" не вдалося.",
