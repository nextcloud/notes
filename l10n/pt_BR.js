OC.L10N.register(
    ...
    "Please chose a valid path in {label} (bottom left corner)." : "Escolha um caminho válido em {label} (canto inferior esquerdo).",
    "See JavaScript console for details." : "Veja o console JavaScript para detalhes.",
    "Saving the note has failed due to insufficient storage." : "O salvamento da anotação falhou devido ao armazenamento insuficiente.",
    ...
    "Updating note {id} has failed." : "A atualização da anotação {id} falhou.",
