OC.L10N.register(
    ...
    "Zen mode ({shortcut})" : "Modo zen ({shortcut})",
    "Exit zen mode ({shortcut})" : "Sair do modo zen ({shortcut})",
    "Share" : "Compartilhar",
    ...
    "Category" : "Categoria",
    "_%n minute_::_%n minutes_" : ["%n minuto","%n de minutos","%n minutos"],
    "The note content could not be loaded." : "Não foi possível carregar o conteúdo da nota.",
    "Access" : "Acesso",
    ...
    "Unable to load the selected note." : "Não foi possível carregar a nota selecionada.",
    "Note" : "Nota",
    "Sharing and versions are not available right now." : "O recurso de compartilhamento e as versões não estão disponíveis no momento.",
    "Owner" : "Proprietário",
    "Today" : "Hoje",
    "Yesterday" : "Ontem",
    ...
    "Could not read the template. Creating an empty note instead." : "Não foi possível ler o modelo. Criando uma nota vazia em vez disso.",
    "Search for notes" : "Pesquisar notas",
    "Loading …" : "Carregando …",
    "Find in all categories" : "Pesquisar em todas as categorias",
    "Blank note" : "Nota em branco",
    ...
    "Note is locked." : "A nota está trancada.",
    ...
    "Renaming category \"{category}\" has failed." : "A renomeação da categoria \"{category}\" falhou.",
