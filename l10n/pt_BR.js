OC.L10N.register(
    ...
    "Search result for \"{{search}}\" in {{SelectedCategory}}" : "Pesquisa para \"{{search}}\" em {{SelectedCategory}}",
    "Search result for \"{{search}}\"" : "Pesquisar resultado para \"{{search}}\"",
    "No search result for {{search}} in {{SelectedCategory}}" : "Sem resultados para {{search}} em {{SelectedCategory}}",
