OC.L10N.register(
    ...
    "Big header" : "Velik naslov",
    "Medium header" : "Srednji naslov",
    "Small header" : "Majhen naslov",
    "Tiny header" : "Droben naslov",
    "Generic list item" : "Osnovni predmet seznama",
    "Generic list" : "Osnovni seznam",
    "Numbered list" : "Oštevilčen seznam",
    "Link title" : "Naslov povezave",
    "link" : "povezava",
    "Image title" : "Naslov slike",
    "image" : "slika",
    "This is a quote." : "To je navedeno besedilo.",
    "quote" : "navedek",
    "code" : "koda",
    "Multi line block code" : "Večvrstični blok kode",
    ...
    "Android app: {notes} by {company}" : "Android: {notes} – {company}",
    "iOS app: {notes} by {company}" : "iOS: {notes} – {company}",
