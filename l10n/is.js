OC.L10N.register(
    ...
    "Updating the note's category has failed." : "Uppfærsla á flokki minnispunkts mistókst.",
    ...
    "Search result for \"{{search}}\" in {{SelectedCategory}}" : "Leitarniðurstöður fyrir \"{{search}}\" í {{SelectedCategory}}",
    "Search result for \"{{search}}\"" : "Leitarniðurstöður fyrir {{search}}\"",
    "No search result for {{search}} in {{SelectedCategory}}" : "Engar leitarniðurstöður fyrir \"{{search}}\" í {{SelectedCategory}}",
    "No search result for {{search}}" : "Engar leitarniðurstöður fyrir {{search}}",
