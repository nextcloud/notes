OC.L10N.register(
    ...
    "Zen mode ({shortcut})" : "Mód Zen ({shortcut})",
    "Exit zen mode ({shortcut})" : "Scoir mód zen ({shortcut})",
    "Share" : "Comhroinn",
    ...
    "For new notes" : "Le haghaidh nótaí nua",
    "Custom file extension" : "Síneadh comhaid saincheaptha",
    "Files" : "Comhaid",
    ...
    "Android" : "Android",
    "iPhone and iPad" : "iPhone agus iPad",
    ...
    "Reading time" : "Am léitheoireachta",
    "Category" : "Catagóir",
    "_%n minute_::_%n minutes_" : ["%n nóiméad","%n nóiméad","%n nóiméad","%n nóiméad","%n nóiméad"],
    "The note content could not be loaded." : "Níorbh fhéidir ábhar an nóta a luchtú.",
    "Access" : "Rochtain",
    ...
    "Unable to load the selected note." : "Ní féidir an nóta roghnaithe a luchtú.",
    "Note" : "Nóta",
    "Sharing and versions are not available right now." : "Níl comhroinnt ná leaganacha ar fáil faoi láthair.",
    "Owner" : "Úinéir",
    "Today" : "Inniu",
    "Yesterday" : "Inné",
    ...
    "Could not read the template. Creating an empty note instead." : "Níorbh fhéidir an teimpléad a léamh. Tá nóta folamh á chruthú ina ionad.",
    ...
    "Start writing a note by clicking on “{newnote}”." : "Tosaigh ag scríobh nóta trí chliceáil ar “{newnote}”.",
    ...
    "Renaming category \"{category}\" has failed." : "Theip ar athainmniú na catagóire \"{category}\".",
    "Deleting category \"{category}\" has failed." : "Theip ar scriosadh na catagóire \"{category}\".",
