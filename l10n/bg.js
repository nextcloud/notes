OC.L10N.register(
    ...
    "Create a sample note with markdown" : "Създаване на примерна бележка с markdown",
    ...
    "Rename" : "Преименувай",
    "Note's title" : "Заглавие на бележка",
    "Details" : "Подробности",
    ...
    "Set category" : "Задава категория",
    "Click here to save manually" : "Кликнете тук, за да запишете ръчно",
    "Saving failed!" : "Записването се провали!",
    "Last modified: {date}" : "Последна промяна: {date}",
    "Note has unsaved changes" : "Бележката има незаписани промени.",
