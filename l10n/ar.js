OC.L10N.register(
    ...
    "Basics" : "الأساسيات",
    "Write down your thoughts without any distractions." : "دَوِّن أفكارَك بيُسرٍ و سَلاسةٍ.",
    ...
    "Set category" : "تحديد الفئة",
    "Click here to save manually" : "أنقُر هنا للحفظ يدويًا",
    "Saving failed!" : "تعذّر الحفظ !",
    "Last modified: {date}" : "آخر تعديل: {date}",
    "Note has unsaved changes" : "الملاحظة بها تغييرات غير محفوظة",
    "Subcategory" : "تصنيف فرعي",
    "Click to edit title" : "أُنقُر لتحرير العنوان",
    "_%n word_::_%n words_" : ["كلمة","كلمة","كلمتان","كلمات","كلمات","%nكلمة"],
    "_%n character_::_%n characters_" : ["%n أحرف","%n حرف","%n أحرف","%n أحرف","%n أحرف","%n أحرف"],
    ...
    "You can create subcategories by using “/” as delimiter between parent category and subcategory, e.g. “{parent}/{sub}”." : "يمكنك إنشاء فئات فرعية باستخدام \"/\" كمُحدِّدٍ بين الفئة الرئيسية والفئة الفرعية. على سبيل المثال “{parent}/{sub}”.",
    ...
    "Updating the note's category has failed. Is the target directory writable?" : "تعذّر تحديث فئة الملاحظات. هل الدليل المَقصِد target directory قابل للكتابة؟",
