OC.L10N.register(
    ...
    "Please chose a valid path in {label} (bottom left corner)." : "נא לבחור נתיב תקני בתוך {label} (פינה ימנית תחתונה).",
    ...
    "Saving the note has failed due to insufficient storage." : "שמירת הפתק נכשלה עקב מחסור בשטח אחסון פנוי.",
    ...
    "Updating note {id} has failed." : "עדכון הפתק {id} נכשל.",
