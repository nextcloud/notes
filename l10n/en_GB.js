OC.L10N.register(
    ...
    "The Notes app is a distraction free notes taking app for [Nextcloud](https://www.nextcloud.com/). It provides categories for better organization and supports formatting using [Markdown](https://en.wikipedia.org/wiki/Markdown) syntax. Notes are saved as files in your Nextcloud, so you can view and edit them with every Nextcloud client. Furthermore, a separate [REST API](https://github.com/nextcloud/notes/blob/master/docs/api/README.md) allows for an easy integration into apps ([Android](https://github.com/nextcloud/notes-android), [iOS](https://github.com/nextcloud/notes-ios), as well as [3rd-party apps](https://github.com/nextcloud/notes/wiki#3rd-party-clients) which allow convenient access to your Nextcloud notes). Further features include marking notes as favorites." : "The Notes app is a distraction free notes taking app for [Nextcloud](https://www.nextcloud.com/). It provides categories for better organisation and supports formatting using [Markdown](https://en.wikipedia.org/wiki/Markdown) syntax. Notes are saved as files in your Nextcloud, so you can view and edit them with every Nextcloud client. Furthermore, a separate [REST API](https://github.com/nextcloud/notes/blob/master/docs/api/README.md) allows for an easy integration into apps ([Android](https://github.com/nextcloud/notes-android), [iOS](https://github.com/nextcloud/notes-ios), as well as [3rd-party apps](https://github.com/nextcloud/notes/wiki#3rd-party-clients) which allow convenient access to your Nextcloud notes). Further features include marking notes as favorites.",
    "Zen mode ({shortcut})" : "Zen mode ({shortcut})",
    "Exit zen mode ({shortcut})" : "Exit zen mode ({shortcut})",
    "Share" : "Share",
    ...
    "Pick a notes folder" : "Pick a notes folder",
    "Set notes folder" : "Set notes folder",
    "General" : "General",
    "Display" : "Display",
    "File extension" : "File extension",
    "For new notes" : "For new notes",
    "Custom file extension" : "Custom file extension",
    "Files" : "Files",
    "Notes folder" : "Notes folder",
    "Show hidden files" : "Show hidden files",
    "Load recently updated note on startup" : "Load recently updated note on startup",
    "Mobile apps" : "Mobile apps",
    "Shortcuts" : "Shortcuts",
    "_Delete category \"{category}\" and its {count} note?_::_Delete category \"{category}\" and its {count} notes?_" : ["Delete category \"{category}\" and its {count} note?","Delete category \"{category}\" and its {count} notes?"],
    ...
    "The note content could not be loaded." : "The note content could not be loaded.",
    "Access" : "Access",
    "Read-only" : "Read-only",
    "Path" : "Path",
    ...
    "Unable to load the selected note." : "Unable to load the selected note.",
    "Note" : "Note",
    "Sharing and versions are not available right now." : "Sharing and versions are not available right now.",
    "Owner" : "Owner",
    "Today" : "Today",
    "Yesterday" : "Yesterday",
    "This week" : "This week",
    ...
    "Could not read the template. Creating an empty note instead." : "Could not read the template. Creating an empty note instead.",
    ...
    "Organize your notes in categories." : "Organise your notes in categories.",
    "Start writing a note by clicking on “{newnote}”." : "Start writing a note by clicking on “{newnote}”.",
    ...
    "Renaming category \"{category}\" has failed." : "Renaming category \"{category}\" has failed.",
    "Deleting category \"{category}\" has failed." : "Deleting category \"{category}\" has failed.",
