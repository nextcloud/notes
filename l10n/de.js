OC.L10N.register(
    ...
    "The Notes app is a distraction free notes taking app for [Nextcloud](https://www.nextcloud.com/). It provides categories for better organization and supports formatting using [Markdown](https://en.wikipedia.org/wiki/Markdown) syntax. Notes are saved as files in your Nextcloud, so you can view and edit them with every Nextcloud client. Furthermore, a separate [REST API](docs/api/README.md) allows for an easy integration into third-party apps (currently, there are notes apps for [Android](https://github.com/stefan-niedermann/nextcloud-notes), [iOS](https://github.com/owncloud/notes-iOS-App) and the [console](https://git.danielmoch.com/nncli/about) which allow convenient access to your Nextcloud notes). Further features include marking notes as favorites." : "Die Notes-App ist eine leicht zu bedienende App zum Erstellen von Notizen in der [Nextcloud](https://www.nextcloud.com/). Zur besseren Übersicht biete sie die Möglichkeit zur Einordnung der Notizen in Kategorien. Für die Formatierung wird der [Markdown](https://en.wikipedia.org/wiki/Markdown)-Syntax unterstützt. Notizen werden als Dateien in der Nextcloud abgelegt. So können sie mit jedem Nextcloud-Client editiert werden. Des Weiteren erlaubt eine separate [REST API](docs/api/README.md) die einfache Integration in Drittabieter-Apps (aktuell gibt es Notes-Apps für  [Android](https://github.com/stefan-niedermann/nextcloud-notes), [iOS](https://github.com/owncloud/notes-iOS-App) und die [Konsole](https://git.danielmoch.com/nncli/file/README.rst.html)  welche bequemen Zugang zu den Notizen in der Nextcloud erlauben). Weitere Features ermöglichen es unter anderem Notizen als Favoriten zu markieren.",
    "Settings" : "Einstellungen",
    "Deleted {title}" : "{title} gelöscht",
    "Deleted {number} notes" : "{number} Notizen gelöscht",
    "Undo Delete" : "Wiederherstellen",
    "Please chose a valid path in {label} (bottom left corner)." : "Bitte wähle einen geeigneten Verzeichnispfad in den {label} (unten links).",
