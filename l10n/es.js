OC.L10N.register(
    ...
    "The Notes app is a distraction free notes taking app for [Nextcloud](https://www.nextcloud.com/). It provides categories for better organization and supports formatting using [Markdown](https://en.wikipedia.org/wiki/Markdown) syntax. Notes are saved as files in your Nextcloud, so you can view and edit them with every Nextcloud client. Furthermore, a separate [REST API](https://github.com/nextcloud/notes/blob/master/docs/api/README.md) allows for an easy integration into apps ([Android](https://github.com/nextcloud/notes-android), [iOS](https://github.com/nextcloud/notes-ios), as well as [3rd-party apps](https://github.com/nextcloud/notes/wiki#3rd-party-clients) which allow convenient access to your Nextcloud notes). Further features include marking notes as favorites." : "La aplicación Notas es una aplicación para tomar notas sin distracciones para [Nextcloud](https://www.nextcloud.com/). Permite categorizar las notas y también darles formato con [Markdown](https://en.wikipedia.org/wiki/Markdown). Las notas se guardan como archivos en tu Nextcloud, para que puedas verlas y editarlas con cualquier cliente de Nextcloud. Además, hay una [API REST](https://github.com/nextcloud/notes/blob/master/docs/api/README.md) que permite integrarla en aplicaciones ([Android](https://github.com/nextcloud/notes-android), [iOS](https://github.com/nextcloud/notes-ios), y también [aplicaciones de terceros](https://github.com/nextcloud/notes/wiki#3rd-party-clients), que te permiten acceder cómodamente a tus notas de Nextcloud). También se puede marcar notas como favoritas.",
    ...
    "_Recovered {number} note_::_Recovered {number} notes_" : ["Se recuperó {number} nota","Se recuperaron {number} notas","Se recuperaron {number} notas"],
