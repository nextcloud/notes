OC.L10N.register(
    ...
    "Big header" : "Велико заглавље",
    "Medium header" : "Средње заглавље",
    "Small header" : "Мало заглавље",
    "Tiny header" : "Сићушно заглавље",
    "Generic list item" : "Ставка опште листе",
    "Generic list" : "Општа листа",
    "Numbered list" : "Нумерисана листа",
    "Link title" : "Наслов линка",
    "link" : "линк",
    "Image title" : "Наслов слике",
    "image" : "слика",
    "This is a quote." : "Ово је навод.",
    "quote" : "навод",
    "code" : "кôд",
    "Multi line block code" : "Блок вишелинијског кода",
