OC.L10N.register(
    ...
    "Zen mode ({shortcut})" : "Zen-vaade ({shortcut})",
    "Exit zen mode ({shortcut})" : "Välju Zen-vaatest ({shortcut})",
    "Share" : "Jaga",
    ...
    "For new notes" : "Uute märkmete jaoks",
    "Custom file extension" : "Sinu määratud faililaiend",
    "Files" : "Failid",
    "Notes folder" : "Märkmete kaust",
    "Show hidden files" : "Näita peidetud faile",
    "Load recently updated note on startup" : "Käivitamisel laadi viimatiuuendatud märge",
    "Mobile apps" : "Nutirakendused",
    "Shortcuts" : "Kiirklahvid",
    "_Delete category \"{category}\" and its {count} note?_::_Delete category \"{category}\" and its {count} notes?_" : ["Kas kustutad „{category}“ kategooria koos oma {count} märkmega?","Kas kustutad „{category}“ kategooria koos oma {count} märkmega?"],
    ...
    "Reading time" : "Lugemisaeg",
    "Category" : "Kategooria",
    "_%n minute_::_%n minutes_" : ["%n minut","%n minutit"],
    "The note content could not be loaded." : "Selle märkme laadimine ei õnnestunud.",
    "Access" : "Ligipääs",
    ...
    "Unable to load the selected note." : "Valitud märkme laadimine ei õnnestu.",
    "Note" : "Märge",
    "Sharing and versions are not available right now." : "Jagamine ja versioonihaldus pole hetkel kasutatav.",
    "Owner" : "Omanik",
    "Today" : "Täna",
    "Yesterday" : "Eile",
    ...
    "Could not read the template. Creating an empty note instead." : "Malli lugemine ei õnnestunud. Selle asemel lisan tühja märkme.",
    "Search for notes" : "Otsi märkmeid",
    "Loading …" : "Sisu on laadimisel…",
    "Find in all categories" : "Otsi kõikidest kategooriatest",
    "Blank note" : "Tühi märge",
    "Create note" : "Koosta märge",
    ...
    "Start writing a note by clicking on “{newnote}”." : "Klõpsi valikut „{newnote}“ ja alusta märkme koostamist.",
    "Note not found." : "Märget ei leidu.",
    "Note is locked." : "Märge on lukus.",
    "Insufficient storage." : "Pole piisavalt andmeruumi.",
    ...
    "Renaming category \"{category}\" has failed." : "„{category}“ kategooria nime muutmine ei õnnestunud.",
    "Deleting category \"{category}\" has failed." : "„{category}“ kategooria kustutamine ei õnnestunud.",
