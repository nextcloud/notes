OC.L10N.register(
    ...
    "The Notes app is a distraction free notes taking app for [Nextcloud](https://www.nextcloud.com/). It provides categories for better organization and supports formatting using [Markdown](https://en.wikipedia.org/wiki/Markdown) syntax. Notes are saved as files in your Nextcloud, so you can view and edit them with every Nextcloud client. Furthermore, a separate [REST API](docs/api/README.md) allows for an easy integration into third-party apps (currently, there are notes apps for [Android](https://github.com/stefan-niedermann/nextcloud-notes), [iOS](https://github.com/owncloud/notes-iOS-App) and the [console](https://git.danielmoch.com/nncli/about) which allow convenient access to your Nextcloud notes). Further features include marking notes as favorites." : "L'application Notes est une application de prise de notes distrayante gratuite pour [Nextcloud](https://www.nextcloud.com/). Elle propose des catégories pour une meilleure organisation et prend en charge la syntaxe [Markdown](https://en.wikipedia.org/wiki/Markdown). Les notes sont sauvegardés sous forme de fichier dans votre Nextcloud, donc vous pouvez les voir et les modifier avec tous les clients Nextcloud. De plus, une [API REST](docs/api/README.md) distincte permet une intégration aisée dans des applications tierces (actuellement, il existe des applications de notes pour [Android](https://github.com/stefan-niedermann/nextcloud-notes), [iOS](https://github.com/owncloud/notes-iOS-App) et [console](https://git.danielmoch.com/nncli/about) qui permettent un accès pratique à vos notes Nextcloud). Les autres fonctionnalités incluent le marquage de notes comme favoris.",
    "Settings" : "Paramètres",
    "Deleted {title}" : "{title} supprimé",
    "Deleted {number} notes" : "Supprimer {number} notes",
    "Undo Delete" : "Annuler la suppression",
    "Please chose a valid path in {label} (bottom left corner)." : "Veuillez sélectionner un chemin valide dans {label} (bottom left corner).",
    ...
    "No search result for “{search}” in {category}" : "Aucun résultat pour “{search}” dans {category}",
    "No search result for “{search}”" : "Aucun résultat trouvé pour “{search}”",
    "Loading …" : "Chargement …",
    "Search result for “{search}” in {category}" : "Résultat pour “{search}” dans {category}",
    "Search result for “{search}”" : "Résultat pour “{search}”",
    "Today" : "Aujourd'hui",
    "Yesterday" : "Hier",
    ...
    "Saving the note has failed due to insufficient storage." : "La note n'a pas pu être enregistrée car l'espace disponible est insuffisant.",
    ...
    "Updating note {id} has failed." : "La mise à jour de la note {id} a échoué.",
