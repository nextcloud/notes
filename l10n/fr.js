OC.L10N.register(
    ...
    "Load recently updated note on startup" : "Charger les notes récemment mises à jour au démarrage",
    "Mobile apps" : "Applications mobiles",
    "Shortcuts" : "Raccourcis",
    "_Delete category \"{category}\" and its {count} note?_::_Delete category \"{category}\" and its {count} notes?_" : ["Supprimer la catégorie \"{category}\" et sa {count} note ?","Supprimer la catégorie \"{category}\" et ses {count} notes ?","Supprimer la catégorie \"{category}\" et ses {count} notes ?"],
    ...
    "Sharing is not available right now." : "Le partage n'est pas disponible pour le moment.",
    "Failed to load the sharing sidebar." : "Impossible de charger la barre latérale de partage.",
    "Unable to load the selected note for sharing." : "Impossible de charger la note sélectionnée pour le partage.",
    "Today" : "Aujourd'hui",
    "Yesterday" : "Hier",
