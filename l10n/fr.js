OC.L10N.register(
    ...
    "The Notes app is a distraction free notes taking app for [Nextcloud](https://www.nextcloud.com/). It provides categories for better organization and supports formatting using [Markdown](https://en.wikipedia.org/wiki/Markdown) syntax. Notes are saved as files in your Nextcloud, so you can view and edit them with every Nextcloud client. Furthermore, a separate [REST API](https://github.com/nextcloud/notes/blob/master/docs/api/README.md) allows for an easy integration into apps ([Android](https://github.com/nextcloud/notes-android), [iOS](https://github.com/nextcloud/notes-ios), as well as [3rd-party apps](https://github.com/nextcloud/notes/wiki#3rd-party-clients) which allow convenient access to your Nextcloud notes). Further features include marking notes as favorites." : "L’application Notes est une application de prise de notes sans distraction pour [Nextcloud](https://www.nextcloud.com/). Elle propose des catégories pour mieux organiser vos notes et prend en charge la mise en forme avec la syntaxe [Markdown](https://en.wikipedia.org/wiki/Markdown). Les notes sont enregistrées sous forme de fichiers dans votre Nextcloud, ce qui vous permet de les afficher et de les modifier avec n’importe quel client Nextcloud. De plus, une [API REST](https://github.com/nextcloud/notes/blob/master/docs/api/README.md) distincte facilite l’intégration dans des applications ([Android](https://github.com/nextcloud/notes-android), [iOS](https://github.com/nextcloud/notes-ios), ainsi que des [applications tierces](https://github.com/nextcloud/notes/wiki#3rd-party-clients) permettant d’accéder facilement à vos notes Nextcloud). Parmi les autres fonctionnalités, vous pouvez notamment ajouter des notes aux favoris.",
    "Zen mode ({shortcut})" : "Mode zen ({shortcut})",
    "Exit zen mode ({shortcut})" : "Quitter le mode zen ({shortcut})",
    "Share" : "Partager",
    ...
    "There are unsaved notes. Leaving the page will discard all changes!" : "Des notes ne sont pas enregistrées. Quitter la page entraînera la perte de toutes les modifications !",
    "Zen mode" : "Mode zen",
    ...
    "The selection will be turned into monospace" : "La sélection sera affichée avec une police à chasse fixe",
    ...
    "Set notes folder" : "Définir le dossier de notes",
    "General" : "Général",
    "Display" : "Affichage",
    "File extension" : "Extension des fichiers",
    "For new notes" : "Pour les nouvelles notes",
    "Custom file extension" : "Extension de fichier personnalisée",
    "Files" : "Fichiers",
    "Notes folder" : "Dossier des notes",
    "Show hidden files" : "Afficher les fichiers masqués",
    "Load recently updated note on startup" : "Charger la note récemment mise à jour au démarrage",
    "Mobile apps" : "Applications mobiles",
    "Shortcuts" : "Raccourcis",
    "_Delete category \"{category}\" and its {count} note?_::_Delete category \"{category}\" and its {count} notes?_" : ["Supprimer la catégorie « {category} » ainsi que {count} note ?","Supprimer la catégorie « {category} » ainsi que {count} notes ?","Supprimer la catégorie « {category} » ainsi que {count} notes ?"],
    ...
    "You cannot select images outside of your notes folder. Your notes folder is: {folder}" : "Vous ne pouvez pas sélectionner d’images en dehors de votre dossier de notes. Votre dossier de notes est : {folder}",
    "Wrong image" : "Mauvaise image",
    "The file was not uploaded. Check your server logs." : "Le fichier n'a pas été téléversé. Vérifiez les logs du serveur.",
    ...
    "The note content could not be loaded." : "Le contenu de la note n'a pas pu être chargé.",
    "Access" : "Accès",
    ...
    "Unable to load the selected note." : "Impossible de charger la note sélectionnée.",
    "Note" : "Note",
    "Sharing and versions are not available right now." : "Le partage et les versions ne sont pas disponibles pour le moment.",
    "Owner" : "Propriétaire",
    "Today" : "Aujourd'hui",
    "Yesterday" : "Hier",
    ...
    "Start writing a note by clicking on “{newnote}”." : "Commencez à rédiger une note en cliquant sur “{newnote}”.",
    "Note not found." : "Note introuvable.",
    "Note is locked." : "La note est verrouillée.",
    "Insufficient storage." : "Espace libre insuffisant.",
    "See JavaScript console and server log for details." : "Voir la console Javascript et les logs du serveur pour plus de détails.",
    ...
    "Toggling favorite for note {id} has failed." : "Impossible d’ajouter ou de retirer la note {id} des favoris.",
    ...
    "Updating the category for note {id} has failed." : "La mise à jour de la catégorie de la note {id} a échoué.",
    "Renaming category \"{category}\" has failed." : "Le changement de nom de la catégorie \"{category}\" a échoué.",
    "Deleting category \"{category}\" has failed." : "La suppression de la catégorie \"{category}\" a échoué.",
    ...
    "Then call IT" : "Ensuite, appeler l’assistance informatique",
    "Quotes" : "Citations",
