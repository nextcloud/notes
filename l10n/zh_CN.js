OC.L10N.register(
    ...
    "Please wait while new settings are applied…" : "正在应用新设置，请等待...",
    ...
    "Categories" : "分类",
    "All notes" : "所有笔记",
    "Search result for \"{{search}}\" in {{SelectedCategory}}" : "在 {{SelectedCategory}} 中关于 \"{{search}}\" 的搜索结果",
    "Search result for \"{{search}}\"" : "关于 \"{{search}}\" 的搜索结果",
    "No search result for {{search}} in {{SelectedCategory}}" : "在 {{SelectedCategory}} 中没有关于 {{search}} 的搜索结果",
