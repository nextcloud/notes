OC.L10N.register(
    ...
    "For new notes" : "对于新笔记",
    "Custom file extension" : "自定义文件扩展名",
    "Files" : "文件",
    "Notes folder" : "笔记文件夹",
    "Mobile apps" : "移动应用",
    "Shortcuts" : "快捷鍵",
    "_Delete category \"{category}\" and its {count} note?_::_Delete category \"{category}\" and its {count} notes?_" : ["删除类别“{category}”及其 {count} 个笔记？"],
    ...
    "Error while renaming note." : "重命名笔记时出错。",
    ...
    "Full screen" : "全屏",
    "Note is read-only. You cannot change it." : "笔记是只读的。您无法对其进行更改。",
    "Save failed. Click to retry." : "保存失败。点击以重试。",
    "Update conflict. Click for resolving manually." : "更新冲突。点击手动解决",
    "Sharing is not available right now." : "共享现在不可用。",
    "Failed to load the sharing sidebar." : "无法加载共享侧边栏。",
    "Unable to load the selected note for sharing." : "无法加载所选笔记进行共享。",
    "Today" : "今天",
    "Yesterday" : "昨天",
    "This week" : "本周",
    "Last week" : "上周",
    ...
    "Organize your notes in categories." : "按类别组织您的笔记。",
    "Start writing a note by clicking on “{newnote}”." : "点击“{newnote}”开始写笔记。",
    ...
    "Renaming category \"{category}\" has failed." : "重命名类别“{category}”失败。",
    "Deleting category \"{category}\" has failed." : "删除类别“{category}”失败。",
    "Uncategorized" : "未分类",
    "Sample note" : "示例笔记",
