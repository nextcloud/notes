OC.L10N.register(
    ...
    "The Notes app is a distraction free notes taking app for [Nextcloud](https://www.nextcloud.com/). It provides categories for better organization and supports formatting using [Markdown](https://en.wikipedia.org/wiki/Markdown) syntax. Notes are saved as files in your Nextcloud, so you can view and edit them with every Nextcloud client. Furthermore, a separate [REST API](https://github.com/nextcloud/notes/blob/master/docs/api/README.md) allows for an easy integration into apps ([Android](https://github.com/nextcloud/notes-android), [iOS](https://github.com/nextcloud/notes-ios), as well as [3rd-party apps](https://github.com/nextcloud/notes/wiki#3rd-party-clients) which allow convenient access to your Nextcloud notes). Further features include marking notes as favorites." : "Aplikácia Notes je aplikácia na písanie poznámok bez rozptyľovania pre [Nextcloud] (https://www.nextcloud.com/). Poskytuje kategórie pre lepšiu organizáciu a podporuje formátovanie pomocou syntaxe [Markdown](https://en.wikipedia.org/wiki/Markdown). Poznámky sa ukladajú ako súbory vo vašom Nextcloud, takže si ich môžete prezerať a upravovať pomocou každého klienta Nextcloud. Okrem toho samostatné [REST API](https://github.com/nextcloud/notes/blob/master/docs/api/README.md) umožňuje jednoduchú integráciu do aplikácií ([Android](https://github .com/nextcloud/notes-android), [iOS](https://github.com/nextcloud/notes-ios), ako aj [3rd-party apps](https://github.com/nextcloud/notes/wiki#3rd-party-clients), ktoré umožňujú pohodlný prístup k vašim poznámkam Nextcloud). Medzi ďalšie funkcie patrí označovanie poznámok ako obľúbených.",
    "Zen mode ({shortcut})" : "Režim bez rušivých prvkov ({shortcut})",
    "Exit zen mode ({shortcut})" : "Ukončiť režim bez rušivých prvkov ({shortcut})",
    "Share" : "Sprístupňovať",
    ...
    "Zen mode" : "Režim bez rušivých prvkov",
    ...
    "Shortcuts" : "Skratky",
    "_Delete category \"{category}\" and its {count} note?_::_Delete category \"{category}\" and its {count} notes?_" : ["Odstrániť kategóriu „{category}“ a jej {count} poznámku?","Odstrániť kategóriu „{category}“ a jej {count} poznámky?","Odstrániť kategóriu „{category}“ a jej {count} poznámok?","Odstrániť kategóriu „{category}“ a jej {count} poznámok?"],
    ...
    "Reading time" : "Čas čítania",
    "Category" : "Kategória",
    "_%n minute_::_%n minutes_" : ["%n minúta","%n minúty","%n minúty","%n minút"],
    "The note content could not be loaded." : "Obsah poznámky sa nepodarilo načítať.",
    "Access" : "Prístup",
    ...
    "Unable to load the selected note." : "Vybranú poznámku sa nepodarilo načítať.",
    "Note" : "Poznámka",
    "Sharing and versions are not available right now." : "Zdieľanie a verzie momentálne nie sú dostupné.",
    "Owner" : "Vlastník",
    "Today" : "Dnes",
    "Yesterday" : "Včera",
    ...
    "Could not read the template. Creating an empty note instead." : "Šablónu sa nepodarilo načítať. Namiesto nej sa vytvorí prázdna poznámka.",
    "Search for notes" : "Vyhľadať poznámky",
    "Loading …" : "Načítava sa …",
    "Find in all categories" : "Hľadať vo všetkých kategóriách",
    "Blank note" : "Prázdna poznámka",
    ...
    "Renaming category \"{category}\" has failed." : "Premenovanie kategórie „{category}“ zlyhalo.",
    "Deleting category \"{category}\" has failed." : "Odstránenie kategórie „{category}“ zlyhalo.",
