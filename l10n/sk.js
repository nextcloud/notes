OC.L10N.register(
    ...
    "Please wait while new settings are applied…" : "Prosím počkajte, kým sa aplikujú nové nastavenia...",
    ...
    "No search result for {{search}}" : "Nenašli sa žiadne výsledky pre vyhľadávanie {{search}}",
