OC.L10N.register(
    ...
    "The Notes app is a distraction free notes taking app. It provides categories for better organization and supports formatting using [Markdown](https://en.wikipedia.org/wiki/Markdown) syntax. Notes are saved as files in your Nextcloud, so you can view and edit them with every Nextcloud client. Furthermore, a separate [RESTful API](https://github.com/nextcloud/notes/wiki/API-0.2) allows for an easy integration into third-party apps (currently, there are notes apps for [Android](https://github.com/stefan-niedermann/nextcloud-notes) and [iOS](https://github.com/owncloud/notes-iOS-App) which allow convenient access to your Nextcloud notes). Further features include marking notes as favorites." : "Poznámky je jednoduchá aplikácia na zaznamenávanie poznámok. Pre lepšiu orientáciu si poznámky môžete zoradiť do kategórií. Písať môžete vo formáte [Markdown](https://en.wikipedia.org/wiki/Markdown). Poznámky sa ukladajú ako súbory vo vašej inštalácii Nextcloudu, takže si ich môžete prečítať a upraviť v každej aplikácii pre Nextcloud. Okrem toho samostatné [RESTful API](https://github.com/nextcloud/notes/wiki/API-0.2) umožňuje jednoduchú integráciu do aplikácií tretích strán (aktuálne sú k dispozícii aplikácie pre [Android](https://github.com/stefan-niedermann/nextcloud-notes) a [iOS](https://github.com/owncloud/notes-iOS-App)). Poznámky si tiež môžete označiť ako obľúbené.",
    "Settings" : "Nastavenia",
    "Deleted {title}" : "Zmazané {title}",
    "Deleted {number} notes" : "Vymazaných {number} poznámok",
    "Undo Delete" : "Zrušiť odstránenie",
    "Please chose a valid path in {label} (bottom left corner)." : "Vyberte platnú cestu v {label} (v ľavom dolnom rohu).",
    ...
    "Saving the note has failed due to insufficient storage." : "Uloženie poznámky zlyhalo pre nedostatok miesta v úložisku.",
    ...
    "Updating note {id} has failed." : "Aktualizácia poznámky {id} zlyhala.",
