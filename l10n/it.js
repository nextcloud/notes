OC.L10N.register(
    ...
    "The Notes app is a distraction free notes taking app for [Nextcloud](https://www.nextcloud.com/). It provides categories for better organization and supports formatting using [Markdown](https://en.wikipedia.org/wiki/Markdown) syntax. Notes are saved as files in your Nextcloud, so you can view and edit them with every Nextcloud client. Furthermore, a separate [REST API](https://github.com/nextcloud/notes/blob/master/docs/api/README.md) allows for an easy integration into apps ([Android](https://github.com/nextcloud/notes-android), [iOS](https://github.com/nextcloud/notes-ios), as well as [3rd-party apps](https://github.com/nextcloud/notes/wiki#3rd-party-clients) which allow convenient access to your Nextcloud notes). Further features include marking notes as favorites." : "L'applicazione Note è un'app per prendere appunti senza distrazioni per [Nextcloud](https://www.nextcloud.com/). Fornisce categorie per una migliore organizzazione e supporta la formattazione utilizzando la sintassi [Markdown](https://en.wikipedia.org/wiki/Markdown). Le note vengono salvate come file nel tuo Nextcloud, così puoi visualizzarle e modificarle con ogni client Nextcloud. Inoltre, una [API REST](https://github.com/nextcloud/notes/blob/master/docs/api/README.md) separata consente una facile integrazione nelle applicazioni ([Android](https://github.com/nextcloud/notes-android), [iOS](https://github.com/nextcloud/notes-ios), così come [applicazioni di terze parti](https://github.com/nextcloud/notes/wiki#3rd-party-clients) che consentono un comodo accesso alle tue note Nextcloud). Ulteriori funzionalità includono la marcatura delle note come preferite.",
    ...
    "For new notes" : "Per nuove note",
    "Custom file extension" : "Estensione di file personalizzata",
    "Files" : "File",
