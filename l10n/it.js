OC.L10N.register(
    ...
    "_Deleted {number} note_::_Deleted {number} notes_" : ["Eliminata {number} nota","Eliminate {number} note"],
    "_Recovered {number} note_::_Recovered {number} notes_" : ["Ripristinata {number} nota","Ripristinate {number} note"],
    ...
    "The note has been changed in another session. Please choose which content should be saved." : "La nota è stata modificata in un'altra sessione. Scegli quale contenuto debba essere salvato.",
