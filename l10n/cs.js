OC.L10N.register(
    ...
    {
    "Notes" : "Poznámky",
    "The last viewed note cannot be accessed. " : "Nedaří se přístup k naposledy zobrazené poznámce. ",
    ...
    "No search result for “{search}” in {category}" : "Žádné výsledky pro hledání „{search}“ v {category}",
    "No search result for “{search}”" : "Žádné výsledky pro hledání „{search}“",
    "Loading …" : "Načítání…",
    "Search result for “{search}” in {category}" : "Výsledky hledání pro „{search}“ v {category}",
