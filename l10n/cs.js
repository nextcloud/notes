OC.L10N.register(
    ...
    "No search result for “{search}” in {category}" : "Žádné výsledky pro vyhledání „{search}“ v {category}",
    "No search result for “{search}”" : "Žádné výsledky pro hledání „{search}“",
    "Loading …" : "Načítání…",
    "Search result for “{search}” in {category}" : "Výsledek hledání pro „{search}“ v {category}",
    "Search result for “{search}”" : "Výsledky hledání „{search}“",
    "Today" : "Dnes",
    "Yesterday" : "Včera",
    ...
    "You can create subcategories by using “/” as delimiter between parent category and subcategory, e.g. “{parent}/{sub}”." : "Podkategorie je možné vytvářet použítím „/“ (dopředné lomítko) jako oddělovače mezi nadřazenou kategorií a podkategorií, např.: „{nadřazená}/{podkategorie}“.",
    "Please chose a valid path in {label} (bottom left corner)." : "Vyberte platný popis umístění v {label} (levý dolní roh).",
    "See JavaScript console for details." : "Podrobnosti viz konzole JavaScript.",
    "Saving the note has failed due to insufficient storage." : "Uložení poznámky se nezdařilo z důvodu nedostatku místa na úložišti (kvóta?)",
    "Updating settings has failed." : "Aktualizace nastavení se nezdařila.",
    "Fetching notes has failed." : "Získávání poznámek se nezdařilo.",
    "Fetching note {id} has failed." : "Získání poznámky {id} se nezdařilo.",
    ...
    "Toggling favorite for note {id} has failed." : "Vyp/zap. oblíbené pro poznámku {id} se nezdařilo.",
    "Updating the note's category has failed. Is the target directory writable?" : "Aktualizace kategorie poznámky se nezdařila. Je cílový adresář kontaktů přístupný pro zápis?",
