OC.L10N.register(
    ...
    "Shortcuts" : "Skróty",
    "_Delete category \"{category}\" and its {count} note?_::_Delete category \"{category}\" and its {count} notes?_" : ["Usunąć kategorię \"{category}\" i jej {count} notatkę?","Usunąć kategorię \"{category}\" i jej {count} notatek?","Usunąć kategorię \"{category}\" i jej {count} notatek?","Usunąć kategorię \"{category}\" i jej {count} notatki?"],
    ...
    "Sharing is not available right now." : "Udostępnianie jest obecnie niedostępne",
    "Failed to load the sharing sidebar." : "Nie udało się wczytać panelu bocznego udostępniania",
    "Unable to load the selected note for sharing." : "Nie można wczytać wybranej notatki do udostępnienia",
    "Today" : "Dzisiaj",
    "Yesterday" : "Wczoraj",
    ...
    "Start writing a note by clicking on “{newnote}”." : "Rozpocznij pisanie notatki, klikając \"{newnote}\".",
    ...
    "Renaming category \"{category}\" has failed." : "Zmiana nazwy kategorii \"{category}\" nie powiodła się.",
    "Deleting category \"{category}\" has failed." : "Usuwanie kategorii \"{category}\" nie powiodło się.",
