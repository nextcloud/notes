OC.L10N.register(
    ...
    "Please see Nextcloud server log for details." : "Bekijk alsjeblieft het Nextcloud-serverlogboek voor details.",
    ...
    "_Deleted {number} note_::_Deleted {number} notes_" : ["Verwijderde {number} notitie","Verwijderde {number} notities"],
    "_Recovered {number} note_::_Recovered {number} notes_" : ["Herstelde {number} notitie","Herstelde {number} notities"],
    ...
    "Error during preparing note for deletion." : "Fout bij voorbereiding notite voor verwijdering",
    "The note has been changed in another session. Please choose which version should be saved." : "De notitie is aangepast in een andere sessie. Kies alsjeblieft welke versie opgeslagen moet worden.",
    ...
    "Note has unsaved changes" : "Notitie heeft veranderingen niet opgeslagen",
    ...
    "It looks that the notes app was installed from a development source. Please install it from the official <a href=\"%1$s\">Nextcloud App Store</a> instead. If you want to build the Notes app by yourself, please follow the <a href=\"%2$s\">developer instructions</a>." : "Het lijkt erop dat de nottities app werd geïnstalleerd vanuit een ontwikkelbron. Installeer de app alsjeblieft vanuit de officiële <a href=\"%1$s\">Nextcloud App Store</a>. Als je de Notities app zelf wilt opbouwen, volg dan de  <a href=\"%2$s\">ontwikkelaarsinstructies</a>."
},
