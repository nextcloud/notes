OC.L10N.register(
    ...
    "_Delete category \"{category}\" and its {count} note?_::_Delete category \"{category}\" and its {count} notes?_" : ["Categorie \"{category}\" en de {count} notitie verwijderen?","Categorie \"{category}\" en de {count} notities verwijderen?"],
    ...
    "Sharing is not available right now." : "Delen is op dit moment niet beschikbaar.",
    "Failed to load the sharing sidebar." : "Kon de zijbalk voor delen niet laden.",
    "Unable to load the selected note for sharing." : "Kon de geselecteerde notitie niet laden om te delen.",
    "Today" : "Vandaag",
    "Yesterday" : "Gisteren",
    "This week" : "Deze week",
    ...
    "Start writing a note by clicking on “{newnote}”." : "Begin met het schrijven van een notitie door op \"{newnote}\" te klikken.",
    ...
    "Renaming category \"{category}\" has failed." : "Hernoemen van categorie \"{category}\" is mislukt.",
    "Deleting category \"{category}\" has failed." : "Verwijderen van categorie \"{category}\" is mislukt.",
