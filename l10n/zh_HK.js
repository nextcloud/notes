OC.L10N.register(
    ...
    "The note has been changed in another session. Please choose which content should be saved." : "該筆記在另一節中已更改。請選擇應保存的版本。",
    ...
    "Undo delete has failed for note {title}." : "復原已刪除筆記 {title} 失敗。",
