OC.L10N.register(
    ...
    "Big header" : "Cabeceira grande",
    "Medium header" : "Cabeceira media",
    "Small header" : "Cabeceira pequena",
    "Tiny header" : "Cabeceira minúscula",
    "Generic list item" : "Elemento xenérico da lista",
    "Generic list" : "Lista xenérica",
    "Numbered list" : "Lista numerada",
    "Link title" : "Título da ligazón",
    "link" : "ligazón",
    "Image title" : "Título da imaxe",
    "image" : "imaxe",
    "This is a quote." : "Esta é unha cita.",
    "quote" : "cita",
    "code" : "código",
    "Multi line block code" : "Código de bloque de varias liñas",
    ...
    "Android app: {notes} by {company}" : "Aplicación de Android: {notes} de {company}",
    "iOS app: {notes} by {company}" : "Aplicación para iOS: {notes} de {company}",
