...
var scssTask = function(fileName, path) {
    ...
    return sass(path + fileName + ".scss", {
        ...
        .pipe(gulp.dest(distPath))
        .pipe(notify({
            message: fileName + ".scss task completed!"
        }));
};
...
gulp.task("js", function() {
    return gulp.src("./src/editormd.js")
        ...
        .pipe(gulp.dest("./"))
        .pipe(notify({
            message: "editormd.js task complete"
        }));
});
...
gulp.task("amd", function() {
    ...
    gulp.src("src/editormd.js")
        ...
        .pipe(gulp.dest("./"))
        .pipe(notify({
            message: "amd version task complete"
        }));
});
...
gulp.task("cm-mode", function() {
    ...
    return gulp.src(modes)
        ...
        .pipe(gulp.dest(codeMirror.path.dist))
        .pipe(notify({
            message: "codemirror-mode task complete!"
        }));
});
...
gulp.task("cm-addon", function() {
    ...
    return gulp.src(addons)
        ...
        .pipe(gulp.dest(codeMirror.path.dist))
        .pipe(notify({
            message: "codemirror-addon.js task complete"
        }));
});
/*
