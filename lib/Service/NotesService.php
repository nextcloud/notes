...
class NotesService {
	 ...
	 * @param list<int> $noteIds ids of the notes that will be serialised
	 */
	public function preloadShareTypes(array $folders, array $noteIds) : void {
		$this->noteUtil->loadShareTypes($folders, $noteIds);
	}
